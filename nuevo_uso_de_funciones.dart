/* void main() {
  ...
  // User usuario2 = User();
  // usuario1.nombre = "Arceo"; // Asignar el valor a las propiedades de el objeto
  // usuario1.edad = 21;
  // usuario2.nombre = "daniel";
  // usuario2.edad = 22;
  usuario1._nombre = "jacobo";
  usuario1._edad = 23;
  usuario1.reporte();
  // usuario2.reporte();
}
...
void main(List<String> args) {
  Persona oswaldo = new Persona();
  oswaldo.aMaterno = "jacobo";
  oswaldo.aPaterno = "arceo";
  oswaldo.nombre = "oswaldo";
  oswaldo.aNacimiento = 2001;

  oswaldo.showName(oswaldo.nombre, oswaldo.aPaterno, oswaldo.aMaterno);
  print("Tienes ${oswaldo.calcularEdad(oswaldo.aNacimiento)} años");
  oswaldo.showname2();
}
